...
<!--
     ...
     2012-11-28 - Version 1.4 (Peter Parslow, for UK Location)
...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt" schemaVersion="1.2">
  ...
  <sch:pattern fpi="ISO19139A1_ROW1">
    <sch:title>Language Encoding</sch:title>
    <sch:p>The Language must be documented if not defined by the encoding standard.</sch:p>
  </sch:pattern>
  ...
  <sch:pattern fpi="ISO19139A1_ROW2">
    <sch:title>Characterset Encoding</sch:title>
    <sch:p>
  ...
  <sch:pattern fpi="ISO19139A1_ROW5">
    <sch:title>Dataset Topic Category</sch:title>
    <sch:p>
  ...
  <sch:pattern fpi="ISO19139A1_ROW6">
    <sch:title>AggregateDataSet</sch:title>
    <sch:p>
  ...
  <sch:pattern fpi="ISO19139A1_ROW7">
    <sch:title>Constraints: Other Restrictions</sch:title>
    <sch:p>
  ...
  <sch:pattern fpi="ISO19139A1_ROW8">
    <sch:title>Dataset Lineage</sch:title>
    <sch:p>
  ...
  <sch:pattern fpi="ISO19139A1_ROW9">
    <sch:title>LevelDescription</sch:title>
    <sch:p>
  ...
  <sch:pattern fpi="ISO19139A1_ROW10">
    <sch:title>Dataset or Series Lineage</sch:title>
    <sch:p>
  ...
  <sch:pattern fpi="ISO19139A1_ROW11">
    <sch:title>Lineage Source and ProcessStep</sch:title>
    <sch:p>
  ...
  <sch:pattern fpi="ISO19139A1_ROW14">
    <sch:title>Source Extent</sch:title>
    <sch:p>
  ...
  <sch:pattern fpi="ISO19139A1_ROW15">
    <sch:title>MD_Georectified: checkPointAvailability</sch:title>
    <sch:p>
  ...
  <sch:pattern fpi="ISO19139A1_ROW16">
    <sch:title>MD_Band: maxValue and minValue</sch:title>
    <sch:p>
  ...
  <sch:pattern fpi="ISO19139A1_ROW18">
    <sch:title>Distribution Format</sch:title>
    <sch:p>
  ...
  <sch:pattern fpi="ISO19139A1_ROW20">
    <sch:title>Obligation</sch:title>
    <sch:p>
  ...
  <sch:pattern fpi="ISO19139A1_ROW24">
    <sch:title>Responsible Party</sch:title>
    <sch:p>
  ...
  <sch:pattern fpi="ISO19139A1_ROW25">
    <sch:title>Distance Unit of Measurement</sch:title>
    <sch:p>
  ...
  <sch:pattern fpi="ISO19139A1_ROW26">
    <sch:title>Length Unit of Measurement</sch:title>
    <sch:p>
  ...
  <sch:pattern fpi="ISO19139A1_ROW27">
    <sch:title>Scale Unit of Measurement</sch:title>
    <sch:p>
  ...
  <sch:pattern fpi="ISO19139A1_ROW28">
    <sch:title>Angle Unit of Measurement</sch:title>
    <sch:p>
  ...
  <sch:pattern abstract="true" id="ResponsiblePartyPattern">
    ...
    <sch:rule context="$context">
      <sch:assert test="count(*/gmd:organisationName) + count(*/gmd:individualName) &gt;= 1">
        At least one organisation name or individual name must be provided.
      </sch:assert>
    </sch:rule>
